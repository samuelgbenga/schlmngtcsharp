...
using Class = myschoolmngapp.Data.Class;
...
[Authorize]
    public class ClassesController : Controller
    {
        ...
        public ClassesController(SchoolMngDBContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,LecturerId,CourseId,Time")] Class @class)
        {
            ...
            // if id you supplied is not same as the class of the id
            // it means that class does not exist
            if (id != @class.Id)
            {
                return NotFound();
            }
